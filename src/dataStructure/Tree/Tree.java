...
public class Tree<AnyType extends Comparable<? super AnyType>>
{
    ...
    public void postOrder2(BinaryNode<AnyType> Node){
        Stack<BinaryNode> stack1=new Stack<>();
        Stack<Boolean> stack2=new Stack<>();
        boolean visited;
        stack1.push(Node);stack2.push(false);
        while(!stack1.empty()&&!stack2.empty()){
            ...
            if(visited) {
                ...
                stack1.push(Node);stack2.push(true);
                stack1.push(Node.right);stack2.push(false);
                stack1.push(Node.left);stack2.push(false);
            }
        }
    }
